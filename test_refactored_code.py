...
def test_error_handling():
    ...
    try:
        from src.database.sharding_manager import TimeBasedShardingStrategy, ShardingConfigError
        from src.database.compression_manager import TimeBasedCompressionStrategy, CompressionConfigError
