...
def main():
    ...
    test_files = [
        (
            "tests/test_database_manager.py::TestDatabaseManagerExceptions::test_database_config_error_invalid_session",
            "DatabaseManager 異常處理",
        ),
        (
            "tests/test_parquet_utils.py::TestParquetExceptions::test_parquet_config_error_invalid_dataframe",
            "Parquet 異常處理",
        ),
    ]
