...
class TestSchemaIntegration:
    ...
    def test_data_shard_file_format_default(self, test_session):
        ...
        # 從資料庫重新查詢驗證
        queried_shard = test_session.query(DataShard).filter_by(shard_id="test_default_format").first()
...
class TestManagerCoordination:
    ...
    def test_concurrent_manager_operations(self, test_session):
        ...
        # 創建多個管理器執行緒
        managers = [ShardingManager, CompressionManager, ChecksumManager, DatabaseManager]
        threads = []
