...
class TestAIModelSignalGenerator(unittest.TestCase):
    ...
    def test_generate_ensemble_signals(self):
        ...
        self.mock_model_manager.get_model_performance.return_value = {
            'accuracy': 0.8
        }
    ...
    def test_prepare_features(self):
        ...
        mock_tech_indicators.calculate_sma.return_value = pd.Series([100.5] * len(self.price_data))
        mock_tech_indicators.calculate_rsi.return_value = pd.Series([50.0] * len(self.price_data))
