...
class TestMissingValueHandler:
    ...
    def test_interpolate_method(self):
        ...
        result = self.handler.handle_missing_values(
            self.test_data.copy(), method="interpolate", columns=["price"]
        )
    ...
    def test_mean_method(self):
        ...
        result = self.handler.handle_missing_values(
            self.test_data.copy(), method="mean", columns=["price"]
        )
    ...
    def test_drop_method(self):
        """Test drop method"""
        result = self.handler.handle_missing_values(
            self.test_data.copy(), method="drop"
        )
...
class TestFeatureCalculator:
    ...
    def test_calculate_bollinger_bands(self):
        ...
        assert (
            last_row["bb_upper_20"]
            >= last_row["bb_middle_20"]
            >= last_row["bb_lower_20"]
        )
...
class TestAdaptiveRateLimiter:
    ...
    def test_adaptive_behavior(self):
        ...
        limiter = AdaptiveRateLimiter(
            initial_rate=2, time_window=1.0, max_rate=5, min_rate=1
        )
