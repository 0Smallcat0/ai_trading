...
class TestRiskManagementIntegration:
    ...
    def test_code_quality_metrics(self):
        ...
        # 驗證品質指標
        assert quality_results["average_pylint_score"] >= quality_targets["min_pylint_score"]
        assert quality_results["max_file_lines"] <= quality_targets["max_file_lines"]
        assert quality_results["docstring_coverage"] >= quality_targets["min_docstring_coverage"]
