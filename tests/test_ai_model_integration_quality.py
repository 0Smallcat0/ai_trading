...
class TestAIModelIntegrationQuality(unittest.TestCase):
    ...
    @patch('src.core.signal_generators.ai_model_signals.MODEL_INTEGRATION_AVAILABLE', True)
    def test_ai_model_signal_generator_import(self):
        """測試 AI 模型訊號產生器導入"""
        try:
            from src.core.signal_generators.ai_model_signals import AIModelSignalGenerator
