...
class TestStrategyAdjustment(unittest.TestCase):
    ...
    def test_strategy_rebacktester(self):
        ...
        # 測試策略重新回測
        result = rebacktester.rebacktest_strategy("moving_average_crossover", {"short_window": 20, "long_window": 50})
    ...
    def test_strategy_tuner(self):
        ...
        tuner.rebacktester.optimize_strategy_parameters = lambda *args, **kwargs: optimization_results
        tuner.rebacktester.compare_strategy_versions = lambda *args, **kwargs: comparison_results
        ...
        # 檢查結果
        self.assertEqual(result["optimized_params"], optimization_results["best_params"])
    ...
    def test_ml_strategy_tuning(self):
        ...
        src.models.model_factory.create_model = lambda *args, **kwargs: MockModel(**kwargs)
