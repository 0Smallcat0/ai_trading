...
try:
    from src.models.ml_models import RandomForestModel, XGBoostModel, LightGBMModel, SVMModel
...
def test_random_forest():
    ...
    rf_clf = RandomForestModel(name="rf_clf", is_classifier=True, n_estimators=10, max_depth=5)
    ...
    # Test regression
    print("\nTesting regression...")
    rf_reg = RandomForestModel(name="rf_reg", is_classifier=False, n_estimators=10, max_depth=5)
...
def test_xgboost():
    ...
    # Test classification
    print("Testing classification...")
    xgb_clf = XGBoostModel(name="xgb_clf", is_classifier=True, n_estimators=10, max_depth=5)
    ...
    # Test regression
    print("\nTesting regression...")
    xgb_reg = XGBoostModel(name="xgb_reg", is_classifier=False, n_estimators=10, max_depth=5)
...
def test_lightgbm():
    ...
    # Test classification
    print("Testing classification...")
    lgb_clf = LightGBMModel(name="lgb_clf", is_classifier=True, n_estimators=10, max_depth=5)
    ...
    # Test regression
    print("\nTesting regression...")
    lgb_reg = LightGBMModel(name="lgb_reg", is_classifier=False, n_estimators=10, max_depth=5)
