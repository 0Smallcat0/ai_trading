...
def test_rule_based_models():
    ...
    try:
        from src.models.rule_based_models import RuleBasedModel, moving_average_crossover
...
def test_backtest_integration():
    ...
    try:
        from src.backtest.backtrader_integration import BacktestEngine, ModelSignalStrategy
        from src.models.rule_based_models import RuleBasedModel, moving_average_crossover
