...
def test_time_series_split():
    ...
    # Check date ranges
    print(
        f"Train date range: {train.index.get_level_values('date').min()} to {train.index.get_level_values('date').max()}"
    )
    print(
        f"Validation date range: {val.index.get_level_values('date').min()} to {val.index.get_level_values('date').max()}"
    )
    print(
        f"Test date range: {test.index.get_level_values('date').min()} to {test.index.get_level_values('date').max()}"
    )
