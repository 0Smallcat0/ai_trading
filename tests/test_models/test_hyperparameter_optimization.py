...
class TestGridSearchOptimizer:
    ...
    def test_optimize_success(self, mock_mlflow, mock_create_model, sample_data, param_grid):
        """測試成功的優化過程"""
        X, y = sample_data
        ...
        # 模擬 GridSearchCV
        with patch('src.models.hyperparameter_optimization.grid_search.GridSearchCV') as mock_grid_search:
