...
def generate_sample_sentiment_data(price_data):
    ...
    news_df = pd.DataFrame({
        ...
        'topic': np.random.choice(['economy', 'company', 'industry', 'market'], len(date_range))
    }, index=date_range)
    ...
    social_df = pd.DataFrame({
        ...
        'platform': np.random.choice(['twitter', 'reddit', 'stocktwits'], len(date_range))
    }, index=date_range)
