...
def test_database_creation():
    ...
    try:
        ...
        expected_tables = [
            'market_daily', 'market_minute', 'market_tick',
            'data_shard', 'data_checksum', 'database_version'
        ]
...
def test_data_shard_table():
    ...
    try:
        ...
        # 檢查必要欄位
        required_fields = [
            'id', 'table_name', 'shard_key', 'shard_id',
            'start_date', 'end_date', 'row_count', 'file_path',
            'file_format', 'file_size_bytes', 'compression', 'is_compressed'
        ]
...
def test_data_checksum_table():
    ...
    try:
        ...
        # 檢查必要欄位
        required_fields = [
            'id', 'table_name', 'record_id', 'checksum',
            'checksum_fields', 'created_at', 'verified_at', 'is_valid'
        ]
