...
class MarketDataProcessor(Processor):
    ...
    def process_message(self, message: Message) -> Optional[Message]:
        ...
        # 計算簡單統計
        prices = [data.get("price", 0) for data in self.market_data[symbol] if "price" in data]
        volumes = [data.get("volume", 0) for data in self.market_data[symbol] if "volume" in data]
