...
此模組包含投資組合的基礎抽象類別和相關異常類別。

主要類別：
- Portfolio: 投資組合基礎抽象類別
...
class Portfolio:
    ...
    def _update_positions_value(self, day_prices: pd.DataFrame, close_col: str) -> None:
        """更新持倉價值
    ...
    def _record_state(self, date: pd.Timestamp) -> None:
        """記錄投資組合狀態
