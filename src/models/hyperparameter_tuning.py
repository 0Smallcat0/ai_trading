...
class HyperparameterTuner:
    ...
    def grid_search(
        self, X: pd.DataFrame, y: pd.Series, log_to_mlflow: bool = True, **kwargs
    ) -> Dict[str, Any]:
        """
        網格搜索
        ...
        try:
            ...
            logger.info(
                f"網格搜索完成，最佳參數: {self.best_params}, 最佳分數: {self.best_score}"
            )
    ...
    def random_search(
        ...
        **kwargs,
        ...
        try:
            # 執行隨機搜索
            logger.info(
                f"開始隨機搜索: {self.model_type}, 參數網格: {self.param_grid}, 迭代次數: {n_iter}"
            )
            ...
            logger.info(
                f"隨機搜索完成，最佳參數: {self.best_params}, 最佳分數: {self.best_score}"
            )
    ...
    def bayesian_optimization(
        ...
        **kwargs,
        ...
        try:
            ...
            # 執行優化
            logger.info(
                f"開始貝葉斯優化: {self.model_type}, 參數網格: {self.param_grid}, 試驗次數: {n_trials}"
            )
            ...
            logger.info(
                f"貝葉斯優化完成，最佳參數: {self.best_params}, 最佳分數: {self.best_score}"
            )
    ...
    def _plot_param_importance(self):
        ...
        for param in param_names:
            ...
            importance_df = importance_df.append(
                {"parameter": param.replace("param_", ""), "importance": importance},
                ignore_index=True,
            )
