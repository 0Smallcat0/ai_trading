"""
Fallback implementation for src/ui/components/backtest_reports.py
This file has been replaced by src/ui/components/backtest_analysis.py
"""
...
def show():
    ...
    st.info(f"請使用: src/ui/components/backtest_analysis.py")
    logger.warning(f"使用了已棄用的模組: src/ui/components/backtest_reports.py")
